ActionController::Routing::Routes.draw do |map|
  ...
  map.connect '/projects/:id/personals', :controller =>'personals', :action=> 'index'
  map.connect '/projects/:id/personals/new', :controller =>'personals', :action=> 'new'
  map.connect '/projects/:id/personals/edit', :controller =>'personals', :action=> 'edit'
  map.connect '/projects/:id/personals/create', :controller =>'personals', :action=> 'create'
  map.connect '/projects/:id/personals/show', :controller =>'personals', :action=> 'show'
