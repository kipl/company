...
ActiveRecord::Schema.define(:version => 20110218180521) do
  ...
  create_table "burndown_data_points", :force => true do |t|
  ...
  create_table "story_actions", :force => true do |t|
    t.integer  "user_id"
    t.integer  "story_id"
    t.integer  "iteration_id"
    t.datetime "created_at"
  ...
  create_table "story_team_members", :force => true do |t|
    t.integer  "user_id"
    t.integer  "story_id"
    t.datetime "created_at"
    t.datetime "updated_at"
